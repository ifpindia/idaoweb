...
<div>
	...
	<form name="frmgeneral" method="post" action="">
		...
		<?php
				...
				if ($errorflag <> "0")	
				{
					echo "<div style=\"text-align:right; font-family:verdana;font-size:12px\">List species above ";
				...
				echo "<th style=\"width:25%;\">Species Name</th>";
				echo "<th style=\"width:15%;\">Percentage</th>";
				
				if ($errorflag <> "0")						
					echo "<th style=\"width:15%;\">Errors</th>";
				echo "</tr></thead><tbody>";
