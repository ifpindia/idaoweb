...
<?php
	...
	{
		echo "<p align='center' class='warning'>There is only one species!!</p>";
		$showflag = 1;		
	}	
...
?>
		...
		<div id="pageright">
			...
			<?php
				if ($showflag == 0)
				{ ?>
					<a href="#" onclick="shownext()"><img src="images/next.jpg" alt=""></a><br>
					<a href="#" onclick="showcancel()"><img src="images/cancel.jpg" alt=""></a><br>
			<?php
				}
				else
				{
